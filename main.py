...
def main(img_path):
    ...
    og_img = skimage.io.imread(img_path)
    test = cv2.imread()
    cls = classifier(og_img)
    ...
    preprocessed_img = preprocess(og_img)
...
for img_path in tqdm(os.listdir('image_classified/normal_img')):
    print(f"[INFO] >>>> Processing {img_path}")
    main('image_classified/normal_img/' + img_path)
# main('images/23868.jpeg')
